...
export { default as Hoverable } from './base/Hoverable.vue'
export { default as UserTooltip } from './base/UserTooltip.vue'
export { default as OrganizationTooltip } from './base/OrganizationTooltip.vue'
export { default as ProjectTooltip } from './base/ProjectTooltip.vue'
export { default as CollectionTooltip } from './base/CollectionTooltip.vue'
...
export { default as OrganizationIcon } from '@/assets/icons/organization.svg?component'
